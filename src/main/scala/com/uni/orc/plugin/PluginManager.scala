...
//import com.uni.orc.models.raw.RawMarketPlugin
...
//				writeToFile(projectPluginsPath, Json.toJson(ModelConverter().getProjectPlugin(Json.parse(source.mkString).as[RawMarketPlugin])))
//				Right()
//		}
//	}
//
